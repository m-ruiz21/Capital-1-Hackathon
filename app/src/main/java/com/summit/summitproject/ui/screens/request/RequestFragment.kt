package com.summit.summitproject.ui.screens.request

import android.content.SharedPreferences
import androidx.compose.runtime.mutableStateOf
import com.summit.summitproject.prebuilt.model.ConversionHelper
...
import com.summit.summitproject.ui.screens.login.*
import androidx.compose.runtime.mutableStateOf
...
class RequestFragment: ViewModel() {
    /**
    ...
    fun saveAccountInfo(sharedPreferences: SharedPreferences) {
        ...
        editor
            ...
            .putString(
                PREF_TRANSACTIONS,
                ConversionHelper.encodeTransactionsToJson(accountInfo.transactions)
            )
            .apply()
    }
}